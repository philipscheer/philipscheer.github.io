...
export default function ThemeToggle({ label }: { label?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-line/20 text-faint transition-colors hover:border-primary hover:text-primary"
    >
